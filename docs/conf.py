...
"""
oddisey_plugin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'oddisey_plugin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/oddisey_plugin",
...
#
# html_title = 'oddisey_plugin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Used for testing concepts from ZachTechGuru',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'oddisey_plugin'),
                os.path.join(root_path, 'oddisey_plugin/migrations')])
