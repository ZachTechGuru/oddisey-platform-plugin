#!/usr/bin/env python
"""
Package metadata for oddisey_plugin.
"""
import os
import re
import sys
...
VERSION = get_version('oddisey_plugin', '__init__.py')
...
setup(
    name='oddisey_plugin',
    version=VERSION,
    description="""Used for testing concepts from ZachTechGuru""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Zach Himself',
    author_email='zach.mcclure.2025.oi@outlook.com',
    url='https://github.com/edunext/oddisey_plugin',
    packages=find_packages(
        include=['oddisey_plugin', 'oddisey_plugin.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
            "oddisey_plugin = oddisey_plugin.apps:OddiseyPluginConfig",
        ],
    },
